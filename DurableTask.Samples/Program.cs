...
namespace DurableTask.Samples
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var sqlSettings = new SqlOrchestrationServiceSettings(ConfigurationManager.ConnectionStrings["DurableDBConnection"].ConnectionString);          
            var provider = new SqlOrchestrationService(sqlSettings);
            ...
            if (CommandLine.Parser.Default.ParseArgumentsStrict(args, ArgumentOptions))
            {
                ...
                provider.CreateAsync(true).Wait();
